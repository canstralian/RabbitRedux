...
def classify_with_gradio(user_input):
    ...
    try:
        response = requests.post(
            "http://127.0.0.1:5000/classify", json={"code": user_input}
        )
...
def launch_interface():
    ...
    iface = gr.Interface(
        ...
        description=(
            "Interact with the WhiteRabbitNeo model for code classification. "
            "This interface connects to a Flask API backend."
        ),
        theme="compact",
    )
