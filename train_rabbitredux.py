...
datasets = {
    ...
    "Code-Functions-Level-General": load_dataset(
        "WhiteRabbitNeo/Code-Functions-Level-General"
    ),
    "Code-Functions-Level-Cyber": load_dataset(
...
augmented_datasets = {
    name: dataset.map(augment_code, batched=False) for name, dataset in datasets.items()
}
